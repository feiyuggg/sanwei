...
define('Renderer/_Texture', function() {
    return Cesium['_Texture'];
});
...
define('Scene/_GroundPolylinePrimitive', function() {
    return Cesium['_GroundPolylinePrimitive'];
});
...
define('Shaders/Appearances/PerInstanceFlatColorAppearanceZBiasVS', function() {
    return Cesium['PerInstanceFlatColorAppearanceZBiasVS'];
});
...
define('Shaders/PostProcessStages/BrightnessContrastGamma', function() {
    return Cesium['BrightnessContrastGamma'];
});
...
define('Shaders/PostProcessStages/Contrast', function() {
    return Cesium['Contrast'];
});
...
define('Shaders/PostProcessStages/LUT', function() {
    return Cesium['LUT'];
});
...
define('Shaders/PostProcessStages/Saturation', function() {
    return Cesium['Saturation'];
});

define('Shaders/PostProcessStages/Sharpen', function() {
    return Cesium['Sharpen'];
});
